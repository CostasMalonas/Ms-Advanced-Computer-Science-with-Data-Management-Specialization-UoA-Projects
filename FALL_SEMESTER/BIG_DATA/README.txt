...
IMPORTANT NOTE:
Sometimes when executing the client script the program freezes when loading the data (If we want to load e.g 3000 rows). Please close the terminals, open new ones and try again.